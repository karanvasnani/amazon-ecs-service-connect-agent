...
|`FIPS_MODE_ENABLED`  | <0 &#124; 1 &#124; true &#124; false> | Indicates whether FIPS mode is enabled for the platform. Accepts truthy values (1, true, TRUE) or falsy values (0, false, FALSE). | false |
